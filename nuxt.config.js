...
const nuxtConfig = {
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'title', content: `${config.name} | Backend Engineer` },
      { name: 'author', content: config.name },
      { property: 'og:type', content: 'website'},
      { property: 'og:url', content: config.social },
      { property: 'og:title', content: `${config.name} | Backend Engineer` },
      ...
      { property: 'twitter:title', content: `${config.name} | Backend Engineer` },
